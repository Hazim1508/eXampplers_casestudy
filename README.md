...
## Automatic Scan
**Alert:-  CSP: Wildcard Directive, CSP: script-src unsafe-eval, CSP: script-src unsafe-inline, CSP: style-src unsafe-inline**
-  Risk: medium
-  Confidence: High
-  CWE ID: 693
...
**Same as automated scan**

-------------------------------------------------------------------------------------------------------------------------------------------------------------------
# JS Library

## Automatic Scan
**Alert: Timestamp Disclouse-Unix**
- **Identify**
  - Risk: low
  - Confidence: low
  - CWE ID: 200
...
- **Identify**
 ...
 - **Evaluate**
   - A cookie set without the HttpOnly flag, which means the cookie can be accessed by Javascript. If a malicious script can be run on this page then the cookie will be accessible and can be transmitted to another site. If this is a session cookie then session hijacking may be possible.
